...
const NAV_ITEMS: {
  ...
  { href: '/inventario',    label: 'Inventario',   icon: Package,     roles: ['ADMIN'],          shortcut: 'Alt+5', activeColor: 'emerald' },
  ...
  { href: '/metricas',      label: 'Métricas',     icon: BarChart3,   roles: ['ADMIN'],          shortcut: 'Alt+8', activeColor: 'emerald' },
  { href: '/empleados',     label: 'Empleados',    icon: Users,       roles: ['ADMIN'],          shortcut: 'Alt+9', activeColor: 'violet' },
  { href: '/nomina',        label: 'Nómina',       icon: DollarSign,  roles: ['ADMIN'],          shortcut: 'Alt+0', activeColor: 'violet' },
